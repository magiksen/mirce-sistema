                                ...
                                <tr>
                                    ...
                                    <?php if ($_SESSION['tipo']=='admin'): ?>
                                        ...
                                        <?php if ($muestra['impresa'] == 'Si'): ?>
                                            <td class="imprimir"><a href="<?php echo RUTA; ?>admin/imprimir.php?id=<?php echo $muestra['id']; ?>&imp=si" title="No Impresa"><i class="fa fa-check" aria-hidden="true" style="color: #1fcb5c;"></i></a></td>
                                        <?php else: ?>
                                            <td class="imprimir"><a href="<?php echo RUTA; ?>admin/imprimir.php?id=<?php echo $muestra['id']; ?>&imp=no" title="Imprimir"><i class="fa fa-print" aria-hidden="true"></i></a></td>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </tr>
                            <?php endforeach; ?>
